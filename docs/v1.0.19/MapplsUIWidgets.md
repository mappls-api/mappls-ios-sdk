...
| :---- | :---- | :---- |
| `1.0.4` | 11 Oct, 2023 | Added theme paramter in initilizer of `MapplsAutocompleteViewController` to set the theme of widget its default value is `.auto`|
