...
| :---- | :---- | :---- |
| `1.0.3` | 03 May 2023 | Added a delegate to set route options and UI improvements.|
...
```swift
// This delegate meathod will be called while making request for route. 
5. didRequestForRoute(routeOptions: RouteOptions) -> RouteOptions?
```
