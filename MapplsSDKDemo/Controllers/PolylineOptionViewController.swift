//
//  PolylineOptionViewController.swift
//  MapplsSDKDemo
//
...
class PolylineOptionViewController: UIViewController {
...
extension PolylineOptionViewController: CommonSearchBarDelegate {
...
extension PolylineOptionViewController: AppThemeChangeable {
...
extension PolylineOptionViewController: NavigationProtocol {
    func navigateBack() {
        navigationController?.popViewController(animated: true)
    }
}

extension PolylineOptionViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let data = optionSelected.subOption[indexPath.row]
        let vc = PolylineViewController()
        vc.polylineSubOptionSelected = data
