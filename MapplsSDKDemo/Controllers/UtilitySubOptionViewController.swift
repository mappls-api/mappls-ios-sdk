//
//  UtilitySubOptionViewController.swift
//  MapplsSDKDemo
//
...
class UtilitySubOptionViewController: UIViewController {
...
extension UtilitySubOptionViewController: CommonSearchBarDelegate {
...
extension UtilitySubOptionViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let data = optionSelected.subOption[indexPath.row]
        let vc = UtilityViewController()
        vc.utilitySubOptionSelected = data
        navigationController?.pushViewController(vc, animated: true)
    }
}

extension UtilitySubOptionViewController: AppThemeChangeable {
...
extension UtilitySubOptionViewController: NavigationProtocol {
    func navigateBack() {
