...
extension CustomIndoorViewController: AppThemeChangeable {
...
extension CustomIndoorViewController: NavigationProtocol {
    func navigateBack() {
        navigationController?.popViewController(animated: true)
    }
}

extension CustomIndoorViewController: MapplsMapViewDelegate {
...
extension CustomIndoorViewController: MapplsIndoorSelectorViewDelegate {
    func tappedButton(_ tag: Int) {
        indoorPlugin?.mapView(self.mapView, switchToFloor: tag)
    }
}

extension CustomIndoorViewController: MapplsMapViewIndoorPluginDelegate {
