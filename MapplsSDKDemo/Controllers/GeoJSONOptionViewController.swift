//
//  GeoJSONOptionViewController.swift
//  MapplsSDKDemo
//
...
class GeoJSONOptionViewController: UIViewController {
...
extension GeoJSONOptionViewController: CommonSearchBarDelegate {
...
extension GeoJSONOptionViewController: AppThemeChangeable {
...
extension GeoJSONOptionViewController: NavigationProtocol {
    func navigateBack() {
        navigationController?.popViewController(animated: true)
    }
}

extension GeoJSONOptionViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let data = optionSelected.subOption[indexPath.row]
        let vc = GeoJSONViewController()
        vc.geoJSONSubOptionSelected = data
