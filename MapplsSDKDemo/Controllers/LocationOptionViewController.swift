...
extension LocationOptionViewController: CommonSearchBarDelegate {
...
extension LocationOptionViewController: AppThemeChangeable {
...
extension LocationOptionViewController: NavigationProtocol {
    func navigateBack() {
        navigationController?.popViewController(animated: true)
    }
}

extension LocationOptionViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let data = optionSelected.subOption[indexPath.row]
        let vc = LocationViewController()
        vc.locationSubOptionSelected = data
