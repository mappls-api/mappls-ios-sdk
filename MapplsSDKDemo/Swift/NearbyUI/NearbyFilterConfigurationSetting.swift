...
//    let sectionForAutocompleteSwitch = 0
    ...
    var selectedNearbyPod: MapplsPodType = .none
    var selectedSortbyFilter: MapplsSortByOrderType = .ascending
    var selectedSearchbyFilter: MapplsSearchByType = .distance
