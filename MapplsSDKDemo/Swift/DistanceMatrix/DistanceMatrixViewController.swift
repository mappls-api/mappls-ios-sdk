...
class DistanceMatrixViewController: UIViewController {
    ...
    func callDistanceMatrix(sourceLocations: [String], destinationLocations: [String], resource: MapplsDistanceMatrixResourceIdentifier, profile: MapplsDirectionsProfileIdentifier) {
        ...
        let distanceMatrixOptions = MapplsDrivingDistanceMatrixOptions(locations: allLocations)
