...
class DemoMapStyleViewController: UIViewController {
    ...
    @objc func switchValueDidChange(_ sender: UISwitch!) {
        if (sender.isOn) {
            print("on")
            MapplsMapConfiguration.setIsShowPreferedMapStyle(true)
        }
        else {
            print("off")
            MapplsMapConfiguration.setIsShowPreferedMapStyle(false)
        }
    }
...
extension DemoMapStyleViewController : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! DemoMapStyleTableViewCell
...
extension DemoMapStyleViewController : MapplsMapViewDelegate {
