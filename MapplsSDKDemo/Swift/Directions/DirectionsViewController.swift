...
class DirectionsViewController: UIViewController {
    ...
    func callDirections(sourceLocation: String, destinationLocation: String, viaLocations: [String], resource: MapplsDirectionsResourceIdentifier, profile: MapplsDirectionsProfileIdentifier) {
        self.clearMap()
...
extension DirectionsViewController: MapplsMapViewDelegate {
