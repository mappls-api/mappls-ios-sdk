//
//  DemoGeoanalyticsViewController.swift
...
class DemoGeoanalyticsViewController: UIViewController , MapplsGeoanalyticsPluginDelegate{
...
extension DemoGeoanalyticsViewController: MapplsMapViewDelegate {
    func mapView(_ mapView: MGLMapView, didFinishLoading style: MGLStyle) {
        
    }
}

extension DemoGeoanalyticsViewController : UITableViewDataSource, UITableViewDelegate {
