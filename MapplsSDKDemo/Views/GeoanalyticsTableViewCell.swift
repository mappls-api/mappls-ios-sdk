//
//  GeoanalyticsTableViewCell.swift
//  MapplsSDKDemo
//
...
extension GeoanalyticsTableViewCell: AppThemeChangeable {
    func appThemeChanged(theme: ThemeColors) {
        DispatchQueue.main.async {
            self.contentView.backgroundColor = theme.backgroundPrimary
            self.styleName.textColor = theme.textPrimary
            self.styleDetails.textColor = theme.textPrimary
        }
    }
}
