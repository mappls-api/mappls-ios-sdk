...
@interface MultipleShapesExample () <MapplsMapViewDelegate>
@property (nonatomic) MapplsMapView *mapView;
@end
...
- (void)viewDidLoad {
    ...
    self.mapView = [[MapplsMapView alloc] initWithFrame:self.view.bounds];
